...
import {TextFromPDFConfig} from './interfaces/text-from-pdf.config';
...
export class GoogleCloudVisionService {
    ...
    detectTextFromPdfFile(
        config: TextFromPDFConfig,
    ): TextPdfResponse {
        ...
        const request: IAsyncBatchAnnotateFilesRequest = {
            requests: [
                {
                    inputConfig,
                    features,
        ...
        return this.client.asyncBatchAnnotateFiles(request)  as TextPdfResponse;
    }
}
